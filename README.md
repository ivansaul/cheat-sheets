...
Cheat Sheets is available for **`Android`** and **`iOS`** devices. For detailed installation instructions, including how to sideload the app using AltStore on iOS, please read the [Installation Guide][installation-guide].
...
[installation-guide]: https://cheatsheet-docs.pages.dev/getting-started/installation
[contributing-guide]: https://cheatsheet-docs.pages.dev/contributing
